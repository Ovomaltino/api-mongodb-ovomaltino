...
export default class EducationRepository implements ISocialFactRepository {
  /**
  ...
  async getSocialFact(
    ...
    limit: string| undefined): Promise<ISocialFact[] | null> {
      ...
      const ret: ISocialFact[] | null = await EducationDB.find(
  ...
  async createSocialFact(data: ISocialFact[]): Promise<ISocialFact[]> {
    const ret: ISocialFact[] = await EducationDB.create(data)
    return ret
  }
  ...
  async updateSocialFact(id: string, data: ISocialFact): Promise<ISocialFact | null> {
    const ret: ISocialFact | null = await EducationDB.findByIdAndUpdate(id, data)
    return ret
  }
  ...
  async deleteSocialFact(id: string): Promise<ISocialFact | null> {
    const ret: ISocialFact | null = await EducationDB.findByIdAndDelete(id)
    return ret
  }
}
