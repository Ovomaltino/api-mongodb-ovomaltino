...
export default class FamilyRepository implements ISocialFactRepository {
  /**
  ...
  async getSocialFact(
    ...
    limit: string| undefined): Promise<ISocialFact[] | null> {
      ...
      const ret: ISocialFact[] | null = await FamilyDB.find(
  ...
  async createSocialFact(data: ISocialFact[]): Promise<ISocialFact[]> {
    const ret: ISocialFact[] = await FamilyDB.create(data)
    return ret
  }
  ...
  async updateSocialFact(id: string, data: ISocialFact): Promise<ISocialFact | null> {
    const ret: ISocialFact | null = await FamilyDB.findByIdAndUpdate(id, data)
    return ret
  }
  ...
  async deleteSocialFact(id: string): Promise<ISocialFact | null> {
    const ret: ISocialFact | null = await FamilyDB.findByIdAndDelete(id)
    return ret
  }
}
